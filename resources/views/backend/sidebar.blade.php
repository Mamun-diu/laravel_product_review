<ul id="sidebar" class="list-group">
    ...
    <li class="list-group-item"><a class="" href="#"><i class="fas fa-cart-plus me-2"></i>Add Product</a></li>
    <li class="list-group-item"><a class="" href="#"><i class="fas fa-eye me-2"></i>show Product</a></li>
    <li class="list-group-item"><a class="" href="#"><i class="fas fa-list-alt me-2"></i>Add Category</a></li>
    <li class="list-group-item"><a class="" href="#"><i class="far fa-eye me-2"></i>Show Category</a></li>
    <li class="list-group-item"><a class="" href="#"><i class="fas fa-dollar-sign me-2"></i>Add Price</a></li>
